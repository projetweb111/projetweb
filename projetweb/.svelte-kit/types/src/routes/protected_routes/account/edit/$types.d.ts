...
type RouteParams = {  }
type RouteId = '/protected_routes/account/edit';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/protected_routes/account/edit/+page.server.js').load>>>>>>;
