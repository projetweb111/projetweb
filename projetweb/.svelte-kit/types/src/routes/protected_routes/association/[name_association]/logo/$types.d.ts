...
type RouteId = '/protected_routes/association/[name_association]/logo';
...
type LayoutRouteId = RouteId | "/protected_routes/association/[name_association]/logo"
...
export type LayoutData = Expand<Omit<LayoutParentData, keyof Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/protected_routes/association/[name_association]/logo/+layout.js').load>>>> & OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/protected_routes/association/[name_association]/logo/+layout.js').load>>>>>>;