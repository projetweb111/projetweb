...
type LayoutRouteId = RouteId | "/" | "/protected_routes/account" | "/protected_routes/account/assos" | "/protected_routes/account/auth" | "/protected_routes/account/photo" | "/protected_routes/account/posts" | "/protected_routes/account/status" | "/protected_routes/account/update" | "/protected_routes/actualite" | "/protected_routes/association" | "/protected_routes/association/[name_association]" | "/protected_routes/search" | "/signIn" | "/signUp" | null
