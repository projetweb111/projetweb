...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => __awaiter(void 0, void 0, void 0, function* () {
      return yield (yield import("./browser-ponyfill-NCMDAOIT.js")).fetch(...args);
    });
  } else {
    _fetch = fetch;
  }
...
var resolveResponse = () => __awaiter5(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-ponyfill-NCMDAOIT.js")).Response;
  }
  return Response;
});
...
var AUTO_REFRESH_TICK_DURATION = 10 * 1e3;
...
init_esm_shims();
init_esm_shims();
var import_cookie2 = __toESM2(require_cookie());
init_esm_shims();
var import_cookie = __toESM2(require_cookie());
