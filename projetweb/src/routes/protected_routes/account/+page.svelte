...
<form class="row flex-center flex">
    ...
    <a  href="/protected_routes/account/photo"  class="avatarPlaceholder" style="margin-left: auto;">
      <img src={url_photo} alt={url_photo ? 'Avatar' : `${loading ? 'Loading ...' : `${downloading ? 'Loading ...' : 'Pas de photo'}`}`} class="avatar image"/>
    </a>
</form>
...
<form class="row flex">
  <a class="button block" href="/protected_routes/account/edit"> Poster un comm'</a> 
</form>
</div>