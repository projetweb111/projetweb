...
type RouteParams = { name_association: string }
type RouteId = '/protected_routes/association/[name_association]';
...
type LayoutRouteId = RouteId | "/protected_routes/association/[name_association]" | "/protected_routes/association/[name_association]/logo"
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/protected_routes/association/[name_association]/+page.server.js').load>>>>>>;
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/protected_routes/association/[name_association]/+layout.server.js').load>>>>>>;
